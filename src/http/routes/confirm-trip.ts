...
import { getTripById, updateTripConfirmation } from "@/service/confirm-trip"
import type { FastifyInstance } from "fastify"
import type { ZodTypeProvider } from "fastify-type-provider-zod"
import z from "zod"


export const confirmTripRoutes = async (app: FastifyInstance) => {
  app.withTypeProvider<ZodTypeProvider>().get(
    ...
    async (request, reply) => {
      ...
      await updateTripConfirmation(tripId)
