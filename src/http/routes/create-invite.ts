...
import z from "zod"
import { createInvite, getTripById } from "@/service/create-invite"
import { getMailClient } from "@/lib/mail"


export const createInviteRoutes = async (app: FastifyInstance) => {
  app.withTypeProvider<ZodTypeProvider>().post(
    ...
    async (request, reply) => {
      ...
      const participant = await createInvite(tripId, email)
