...
ok 1 - swagger route does not return additional theme # time=42.681ms
...
ok 2 - swagger route returns additional theme # time=7.644ms
...
ok 3 - swagger route returns additional theme - only js # time=6.054ms
...
# Subtest: swagger route returns additional theme - only css
    ...
    ok 3 - should be equal
    ok 4 - should be equal
ok 4 - swagger route returns additional theme - only css # time=5.387ms
...
# Subtest: swagger route returns additional theme - only favicon
    ...
    ok 4 - should be equal
    ok 5 - should be equal
ok 5 - swagger route returns additional theme - only favicon # time=7.356ms
...
# Subtest: swagger route returns additional theme - only title
    ...
    ok 2 - should match pattern
    ok 3 - should be equal
ok 6 - swagger route returns additional theme - only title # time=4.44ms
