...
ok 1 - transformSpecification should modify the json # time=40.878ms
...
ok 2 - transformSpecificationClone false should not deepclone fastify.swagger() /1 # time=5.138ms
...
ok 3 - transformSpecification should modify the yaml # time=11.793ms
...
ok 4 - transformSpecificationClone false should not deepclone fastify.swagger() /2 # time=4.731ms
