...
ok 1 - swagger route returns yaml # time=65.812ms
...
ok 2 - swagger route returns json # time=11.222ms
...
ok 3 - postProcessor works, swagger route returns updated yaml # time=11.574ms

# Subtest: swagger route returns explicitly passed doc
    1..2
    ok 1 - must match snapshot
    ok 2 - valid explicitly passed spec document
ok 4 - swagger route returns explicitly passed doc # time=1.909ms
...
ok 5 - /documentation/:file should serve static file from the location of main specification file # time=27.922ms

# Subtest: /documentation/non-existing-file calls custom NotFoundHandler
    1..1
    ok 1 - should be equal
ok 6 - /documentation/non-existing-file calls custom NotFoundHandler # time=7.562ms

# Subtest: /documentation/:file should be served from custom location
    1..2
    ok 1 - should be equal
    ok 2 - should be equal
ok 7 - /documentation/:file should be served from custom location # time=14.288ms

# Subtest: /documentation/:file should be served from custom location with trailing slash(es)
    1..2
    ok 1 - should be equal
    ok 2 - should be equal
ok 8 - /documentation/:file should be served from custom location with trailing slash(es) # time=6.422ms
...
ok 9 - /documentation/yaml returns cache.swaggerString on second request in static mode # time=8.495ms
...
ok 10 - /documentation/json returns cache.swaggerObject on second request in static mode # time=5.382ms
...
# Subtest: /documentation/yaml returns cache.swaggerString on second request in dynamic mode
    ...
    ok 5 - should be equal
    ok 6 - valid swagger yaml
ok 11 - /documentation/yaml returns cache.swaggerString on second request in dynamic mode # time=12.742ms
...
# Subtest: /documentation/json returns cache.swaggerObject on second request in dynamic mode
    ...
    ok 5 - should be equal
    ok 6 - valid swagger json
ok 12 - /documentation/json returns cache.swaggerObject on second request in dynamic mode # time=5.227ms
